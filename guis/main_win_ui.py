...
"}")
        ...
        self.title_label.setGeometry(QRect(130, 10, 250, 60))
        font = QFont()
...
"}")
        ...
        self.start_stop_button.setGeometry(QRect(35, 150, 90, 25))
        font1 = QFont()
        ...
        self.change_id_button.setGeometry(QRect(160, 150, 90, 25))
...
"	color: red;\n"
"}")
        self.ip_address_label = QLabel(self.centralwidget)
        self.ip_address_label.setObjectName(u"ip_address_label")
        self.ip_address_label.setGeometry(QRect(125, 110, 150, 25))
        self.ip_address_label.setStyleSheet(u"#ip_address_label {\n"
"	color: white;\n"
"}")
        self.ip_address_header_label = QLabel(self.centralwidget)
        self.ip_address_header_label.setObjectName(u"ip_address_header_label")
        self.ip_address_header_label.setGeometry(QRect(35, 110, 90, 25))
        self.ip_address_header_label.setFont(font2)
        self.ip_address_header_label.setStyleSheet(u"#ip_address_header_label{\n"
"	color: white;\n"
"}")
        self.status_button = QPushButton(self.centralwidget)
        self.status_button.setObjectName(u"status_button")
        self.status_button.setGeometry(QRect(285, 70, 90, 25))
